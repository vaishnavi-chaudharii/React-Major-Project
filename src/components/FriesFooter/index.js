...
import {FooterContainer, FooterWrapper, SocialMedia, SocialMediaWrapper, SocialLogo, SocialIcons, SocialIconLink} from './FooterElement'
    ...
    return (
        ...
        <FooterContainer>
            <FooterWrapper>
                <SocialMedia>
                    <SocialMediaWrapper>
                        <SocialLogo to="/">Fries</SocialLogo>
                        <SocialIcons>
